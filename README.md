...
As shown in the module panel, select the WSI file to view in the "Select WSI" box. Then click "Load WSI" below.

One can then view different region/scale of the image as shown below:
